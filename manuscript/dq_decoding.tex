...
\section{Results}\label{s:results}
	...
	\end{equation}
	where $|\mathcal{A}|$ is the size of the action space, and an additional single neuron output for value prediction, as required by dueling methodologies \cite{RLwang2015dueling}, was also included.
	...
	We then considered both bit-flip and depolarizing noise models.
...
\section{Conclusion}\label{s:conclusions}
	...
	There are a plethora of natural and interesting ways of extending these initial results. 
	...
	The aforementioned approach of multiple communicating agents acting on fixed size sublattices could however provide a promising approach to this problem.
...
% Acknowledgments
	\begin{acknowledgments}
		The authors gratefully acknowledge helpful and insightful discussions with Daniel Litinski, Nicolas Delfosse, Aleksander Kubica, Thomas Jochym-O'Connor, Paul Baireuther, James Wooton and Hendrik Poulsen Nautrup.
		...
		This work has also received funding from the European Union's Horizon 2020
...
\section{Agent Hyper-Parameters and Learning Curves}\label{A:parameters}
	...
	\begin{equation}
		[[64,3,2],~[32,2,1],~[32,2,1],~[512,0.2],~[|\mathcal{A}|, 0]],
	\end{equation}
	with an additional single output for value prediction, as required for dueling methodologies \cite{RLwang2015dueling}. Single convolutional layers have been described with a three-tuple $[n,w,s]$, where $n$ is the number of filters, $w$ is the filter width and $s$ is the stride, and single feed forward layers via a two-tuple $[n,d]$, where $n$ is the number of neurons and $d$ is the output drop-out rate.
